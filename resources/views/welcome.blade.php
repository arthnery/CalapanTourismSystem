...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>Calapan City Tourism</title>
    ...
    <body class="antialiased selection:bg-blue-100">
        <div class="relative min-h-screen">
            <!-- Navigation Bar: Apple Glassmorphism Style -->
                            ...
                            @if (Route::has('login'))
                                ...
                                @else
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="text-sm font-medium hover:text-blue-600 transition">Register</a>
                                    @endif
                                @endauth
                            @endif
                        </div>
            ...
            <div class="relative h-[80vh] flex items-center justify-center bg-white overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-b from-gray-50 to-white"></div>
                <div class="z-10 text-center px-4">
                    <h1 class="text-6xl md:text-8xl font-bold tracking-tighter mb-6 force-gradient">
                        Explore Calapan.
                    </h1>
                    <p class="text-xl md:text-2xl text-gray-500 mb-10 max-w-2xl mx-auto font-medium">
                        Experience the natural beauty and vibrant culture of Calapan City.
                    </p>
                    <div class="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
                        <a href="#spots" class="apple-button-primary text-lg px-10">Get Started</a>
                        <a href="#categories" class="apple-button-secondary text-lg group">
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div class="apple-card p-1">
                    <form action="{{ route('home') }}" method="GET" class="flex flex-col md:flex-row items-center gap-2">
